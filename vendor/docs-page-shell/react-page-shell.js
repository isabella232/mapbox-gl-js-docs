...
function Search(props) {
  ...
  return React.createElement("div", {
    ...
    href: "#",
    className: "st-search-show-outputs shell-txt-s-mm shell-flex-parent shell-flex-parent--center-cross round-less ".concat(darkText ? 'shell-btn shell-btn--blue' : 'shell-btn shell-btn--white'),
    style: {
      fontWeight: '400'
    }
    ...
    d: "M7.5,3C5,3,3,5,3,7.5S5,12,7.5,12c0.9,0,1.7-0.2,2.3-0.7l0,0l3.4,3.4c0.2,0.2,0.4,0.3,0.7,0.3c0.6,0,1-0.4,1-1 c0-0.3-0.1-0.5-0.3-0.7l-3.4-3.4l0,0c0.4-0.7,0.7-1.5,0.7-2.3C12,5,10,3,7.5,3z M7.5,4.5c1.7,0,3,1.3,3,3s-1.3,3-3,3s-3-1.3-3-3 S5.8,4.5,7.5,4.5z"
  }))), "Search", React.createElement("span", {
    className: "inline-block none-mm ml3"
  }, "docs")));
}
...
function Logo(props) {
  ...
  nameClasses += 'shell-txt-l-ml shell-txt-l shell-txt-s-mm ';
